 ...
 * @Last Modified time: 2016-11-14 11:54:26
 */
...
module.exports = {
  ...
  entry: {
    ...
    /** 废弃--- vendor 使用 dll 方式引入，提高开发环境下的编译效率
    //vendor: [
        //'jquery'
  ...
  module: {
    ...
    loaders: [{
      ...
      //如果小于8192kb将会以base64形式存在，否则产生文件
  ...
  plugins: [
    Pconf.definePluginConf(setting.definePluginOptions), !setting.isDev ? Pconf.uglifyJsPluginConf() : Pconf.noopPluginConf(),
